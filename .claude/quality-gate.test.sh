...
# `set -o pipefail` the resulting SIGPIPE read as "not protected". 3000
# entries is far past any real checkout; the point is that the size of the list cannot decide the answer.
